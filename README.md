...
* Load balancing is useful in case when large number of users hit the server.This Load balancing will divide and direct them to different ip address but look and feel will be the same. 
